  ...
  if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  move_uploaded_file($img_temp, 'C:\xampp\htdocs\Hema\assets\img\centers\\' . $img_name);
  
  $Query = "insert into centers (name, address, type, phone, link, image) values ('$name', '$address', '$type', '$phone', '$link', '$img_name')";
  // $Query = "insert into pharmacies (name, details, phone, link, image) values ('$name', '$details', '$phone', '$link', '$img_name')";
          ...
          <div class="content-wrapper">
            ...
            <div class="div_center">
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <h1 class="card-title">اضافة مركز</h1>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input name="address" type="text" class="form-control" id="exampletitle"  placeholder="" required>
                            </div>
                          </div>
