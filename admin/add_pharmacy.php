  ...
  if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  move_uploaded_file($img_temp, 'C:\xampp\htdocs\Hema\assets\img\pharmacies\\' . $img_name);
          ...
          <div class="content-wrapper">
            ...
            <div class="div_center">
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <h1 class="card-title">اضافة صيدلية</h1>
                          <div class="form-group row">
                            <label for="exampletitle" class="col-sm-3 col-form-label">الاسم</label>
                            <div class="col-sm-9">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input name="phone" type="text" class="form-control"  id="exampleprice" placeholder="">
                            </div>
                          </div>
                          <div class="form-group row">
