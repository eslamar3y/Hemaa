  ...
  if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  $Query = "insert into public_services (service_name, service_type, details, phone, Link) values ('$service_name', '$service_type', '$details', '$phone', '$Link')";
  if(mysqli_query($conn, $Query))
  {
      header("Location: public_services.php?status=Added");
  }
}
?>
<!DOCTYPE html>
          ...
          <div class="content-wrapper">
            ...
            <div class="div_center">
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <h1 class="card-title">اضافة خدمة عامة</h1>
                        <div class="form-group row">
                            <label for="exampletitle" class="col-sm-3 col-form-label">اسم الخدمة</label>
                            <div class="col-sm-9">
                              <input name="service_name" type="text" class="form-control" id="exampletitle"  placeholder="" required>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="exampletitle" class="col-sm-3 col-form-label">نوع الخدمة</label>
                            <div class="col-sm-9">
                              <input name="service_type" type="text" class="form-control" id="exampletitle"  placeholder="" required>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="exampledescription" class="col-sm-3 col-form-label">التفاصيل</label>
                            <div class="col-sm-9">
                              <textarea name="details" style="height: 120px" type="text" class="form-control" id="" required></textarea>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="exampleprice" class="col-sm-3 col-form-label">الجوال</label>
                            <div class="col-sm-9">
                              <input name="phone" type="text" max="5" min="1" class="form-control" id="exampleprice" placeholder="">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="exampleprice" class="col-sm-3 col-form-label">الرابط</label>
                            <div class="col-sm-9">
                              <input name="Link" type="text" class="form-control" id="exampleprice" placeholder="">
                            </div>
                          </div>
                        </div>
