  ...
  if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  move_uploaded_file($img_temp, 'C:\xampp\htdocs\Hema\assets\img\restaurants\\' . $img_name);
  
  $Query = "insert into restaurants (name, details, phone, link, image) values ('$name', '$details', '$phone', '$link', '$img_name')";
          ...
          <div class="content-wrapper">
            ...
            <div class="div_center">
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <h1 class="card-title">اضافة مطعم</h1>
