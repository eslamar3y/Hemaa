                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><a onclick="return confirm('هل تريد حذف رسالة   <?=$row['name']?>')" href="delete_message.php?id=<?=$row['id']?>" class="btn btn-danger">حذف</a></td>
                        <td><a href="respond_message.php?id=<?=$row['id']?>" class="btn btn-warning">تفاصيل</a></td>
                        <?php
                        if($row['respond'])
                        {
                          ?>
                          <td><a href="#" class="btn btn-success disabled">تم الرد</a></td>
                          <?php
                        }
                        else
                        {
                          ?>
                          <td><a href="#" class="btn btn-warning disabled">لم يتم الرد</a></td>
                          <?php
                        }
                        ?>
