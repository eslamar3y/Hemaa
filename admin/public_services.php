                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><?=$row['Link']?></td>
                        <td><a onclick="return confirm('هل تريد حذف  <?=$row['service_name']?>')" href="delete_service.php?id=<?=$row['service_id']?>" class="btn btn-danger">حذف</a></td>
                        <td><a class="btn btn-warning"  href="update_service.php?id=<?=$row['service_id']?>">تعديل</a></td>
