                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><?=$row['phone']?></td>
                        <td><?=$row['link']?></td>
                        <td><img class="img-responsive" style="width: 100px;height: 100px;" src="../assets/img/restaurants/<?=$row['image']?>" alt=""></td>
                        
                        <td><a onclick="return confirm('هل تريد حذف مطعم  <?=$row['name']?>')" href="delete_restaurant.php?id=<?=$row['restaurant_id']?>" class="btn btn-danger">حذف</a></td>
                        <td><a class="btn btn-warning"  href="update_restaurant.php?id=<?=$row['restaurant_id']?>">تعديل</a></td>
