                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><?=$row['phone']?></td>
                        <td><?=$row['link']?></td>
                        <td><img class="img-responsive" style="width: 100px;height: 100px;" src="../assets/img/centers/<?=$row['image']?>" alt=""></td>
                        
                        <td><a onclick="return confirm('هل تريد حذف صيدلية  <?=$row['name']?>')" href="delete_center.php?id=<?=$row['center_id']?>" class="btn btn-danger">حذف</a></td>
                        <td><a class="btn btn-warning"  href="update_center.php?id=<?=$row['center_id']?>">تعديل</a></td>
