                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><img class="img-responsive" style="width: 100px;height: 100px;" src="../assets/img/diseases/<?=$row['image']?>" alt=""></td>
                        <td><?=$row['last_edit']?></td>
                        
                        <td><a onclick="return confirm('هل تريد حذف صيدلية  <?=$row['name']?>')" href="delete_instruction.php?id=<?=$row['instruction_id']?>" class="btn btn-danger">حذف</a></td>
                        <td><a class="btn btn-warning"  href="update_instruction.php?id=<?=$row['instruction_id']?>">تعديل</a></td>
