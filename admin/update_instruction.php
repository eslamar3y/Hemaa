      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <?php
              $select="SELECT * FROM `instructions` WHERE `instruction_id` =" .$id. " LIMIT 1";
                        ...
                        <h1 class="card-title">تحديث الخدمة</h1>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              {
                                ?>
                                <option selected value="ذهنية">ذهنية</option>
                                <option value="جسدية">جسدية</option>
                                <?php
                              }
                              else if($row['type'] == 'جسدية')
                              {
                                ?>
                                <option value="ذهنية">ذهنية</option>
                                <option selected value="جسدية">جسدية</option>
                                <?php
                              }
                                ?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea name="instruction" style="height: 320px; line-height:2;" type="text" class="form-control" id="" required><?= $row['instructions'] ?></textarea>
                            </div>
                          </div>
                        </div>
