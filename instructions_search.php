    ...
    <section id="recent-blog-posts" class="recent-blog-posts">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>الارشادات</h2>
          <p>اهم الارشادات لكل حالة</p>
        </header>
        <form method="get" action="instructions_search.php" style="display:flex;justify-content: center;margin-top:30px;margin-bottom:30px">
        ...
        <?php
          ...
          $query = "SELECT * FROM `instructions` where `name` LIKE '%$searchtxt%'";
          ...
          <div class="col-lg-4">
            <div class="post-box">
              <div class="post-img"><img src="assets/img/diseases/<?=$row['image']?>" style="height:250px;width:100%;" class="img-fluid" alt=""></div>
              <span class="post-date">اخر تعديل: <?=$row['last_edit']?></span>
              <h3 class="post-title"><?=$row['name']?></h3>
              <a href="single-instruction.php?id=<?=$row['instruction_id']?>" class="readmore stretched-link mt-auto">
