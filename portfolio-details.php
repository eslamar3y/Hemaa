...
$sql = "SELECT * FROM centers WHERE center_id = '$id'";
    ...
    <section class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li><a href="portfolio.php">المراكز</a></li>
          <li>تفاصيل المركز</li>
        </ol>
        <h2>تفاصيل المركز</h2>
      </div>
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="assets/img/centers/<?=$row['image']?>" alt="" />
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul style="font-size:20px">
                <li><strong>النوع: </strong><?=$row['type']?></li>
                <br>
                <li><strong>العنوان: </strong><?=$row['address']?></li>
                <br>
                <li><strong>الجوال: </strong><p style="display:inline" dir="ltr"><?=$row['phone']?></p></li>
                <br>
                <li><strong>الرابط: </strong><a href="<?=$row['link']?>" target="_blank">اضغط هنا</a></li>
              </ul>
            </div>
