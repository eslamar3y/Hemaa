    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <?php
          ...
          $query = "SELECT * FROM `centers` where `type` = 'تعليمية'";
        ...
        <?php
          require_once('connection.php');
          $query = "SELECT * FROM `centers` where `type` = 'علاجية'";
          // $query = "SELECT * FROM `users` WHERE `email` ='" . $email . "' and `password` = '" . $password ;
          ...
          <?php
          require_once('connection.php');
          $query = "SELECT * FROM `centers` where `type` = 'تأهيلية'";
          // $query = "SELECT * FROM `users` WHERE `email` ='" . $email . "' and `password` = '" . $password ;
          ...
          <?php
          require_once('connection.php');
          $query = "SELECT * FROM `centers` where `type` = 'ترفيهية'";
          // $query = "SELECT * FROM `users` WHERE `email` ='" . $email . "' and `password` = '" . $password ;
