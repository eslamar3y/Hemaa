        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-box blue">
              ...
              <h3>مطاعم</h3>
              <p>
                مطاعم تقدم أصنافًا متنوعة من الطعام، تتضمن الوجبات السريعة
                والوجبات الفاخرة والأطباق التقليدية والعالمية. تتميز بجوها
                المريح وخدمة الزبائن الراقية.
              </p>
              <a href="restaurants.php" class="read-more">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-box orange">
              ...
              <h3>صيدليات</h3>
              <p>
                أماكن توفر الأدوية والمستلزمات الطبية للمرضى والمصابين
                بالأمراض المزمنة والحالات الطارئة، فيتامينات صحية، مستلزمات
                علاجية.
              </p>
              <a href="pharmacies.php" class="read-more">
                <i class="bi bi-arrow-right"></i>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-box green">
              ...
              <h3>سوبرماركت</h3>
              <p>
                بيع بالجملة، مستلزمات المنزل، منتجات الأطعمة الطازجة، عروض
                خاصة، تنوع في المنتجات، خدمة التوصيل، خدمة العملاء الممتازة.
              </p>
              <a href="markets.php" class="read-more">
                <i class="bi bi-arrow-right"></i>
                <span>عرض المزيد</span>
              </a>
            </div>
          ...
          ?>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
              <div class="service-box red">
                ...
                <p style="opacity: 0.7;">جوال:
                  <?= $row['phone'] ?>
                </p>
                <a href="<?= $row['Link'] ?>" class="read-more" target="_blank">
                  <i class="bi bi-arrow-right"></i>
                  <span>تفاصيل</span> 
                </a>
              </div>
