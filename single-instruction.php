...
$sql = "SELECT * FROM instructions WHERE instruction_id = '$id'";
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li><a href="instructions.php">الارشادات</a></li>
          <li>تفاصيل</li>
        </ol>
        <h2>تفاصيل</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="assets/img//diseases/<?= $row['image']?>" alt="" style="width:100%" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="#">كيفية التعامل مع <?= $row['name']?></a>
                <p style="font-size:14px;opacity: 0.7;margin-top:5px;margin-right:6px"><?= $row['type']?></p>
              </h2>
              ...
              <div class="entry-content" >
                ...
                <blockquote>
                  <p style="font-style:normal !important">
                    قال الله تعالي في كتابه الكريم:- {ليس علي الأعمي حرج ولا علي الأعرج حرج ولا علي المريض حرج}&nbsp;&nbsp;&nbsp;[النور: الآيه 61]
                </p>
                </blockquote>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              <h3 class="sidebar-title">اخر الاضافات</h3>
              <div class="sidebar-item recent-posts">

              <?php
                require_once('connection.php');
                $query = "SELECT * FROM `instructions` order by `instruction_id` DESC Limit 5 ";
              ...
              ?>
                ...
                <div class="post-item clearfix">
                  <img src="assets/img/diseases/<?= $row['image'] ?>" alt="">
                  <h4><a href="single-instruction.php?id=<?= $row['instruction_id'] ?>">التعامل مع <?= $row['name'] ?></a></h4>
                  <time datetime="2020-01-01"><?= $row['last_edit'] ?></time>
                </div>
